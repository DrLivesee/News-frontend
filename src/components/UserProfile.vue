<template>
  <div v-if="userStore.isAuth" class="user-profile">
  ...
  <LoadingIcon v-if="userStore.isLoading"  :loadingCustom="loadingCustom"/>
</template>
...
const loadingCustom = ref({ height: '50px', width: '50px', alignSelf: 'flex-end'})
